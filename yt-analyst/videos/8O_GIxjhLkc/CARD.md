...
**Method vocabulary.** Smart Money Concepts on the higher timeframes: 1h/4h "imbalance" (fair value gaps, drawn as boxes, `1h FVG` / `15m FVG` labels on screen), plus **BULL TRAP / BEAR TRAP** labels from an indicator titled `SMC HTF/LTF` (frames). Order flow is a bubble overlay he calls **"Delta Flow"** (spoken 00:23) with a per-bar Volume / Delta / Min delta / Max delta table under the 1-minute chart (frames). *"That dark ring around the circle, that shows me that we have higher than 50 contracts per second going off"* (07:40–07:45, transcript; the earlier wording was Gemini's paraphrase). Entry criteria, spoken 08:10–08:19: *"We have a downtrend. We have a potential short situation. We see a potential trap. We have exhaustion, and we have sellers pumping in. Now, what do we need? We need a shift in control and a break of structure."* — at a retest of the **7,800 "psychological level"** (spoken 07:20). *(Corrected 2026-09-07: the earlier list, with "seller absorption" and "1-minute", was Gemini's paraphrase.)*

**Pitches.** Free book download *"Order Flow Trading Secrets"* (banner 04:19), a VWAP book (10:34), an invitation to *"trade alongside me and our team of prop firm funded traders every day"* (11:29–11:39; the Academy is not named in the outro — corrected 2026-09-07).
