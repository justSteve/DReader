...
2. **Wide pass once.** Whole video, no clipping, defaults:
   ...
   This is the map and the expensive shape (~300 tokens/second of video).
   One per video, ever, unless the question demands a different wide framing.
...
4. **Cross-check arithmetic before trusting numbers.** Transcribed figures
   ...
   are near-certainly transcribed correctly; hallucinated numbers don't do
   arithmetic. Run these checks yourself.
